...
public class TaskExecutorPartitionHandler extends AbstractPartitionHandler implements StepHolder, InitializingBean {
    ...
    protected Set<StepExecution> doHandle(StepExecution masterStepExecution,
        ...
        for (final StepExecution stepExecution : partitionStepExecutions) {
            final FutureTask<StepExecution> task = createTask(step, masterStepExecution, stepExecution);
    ...
    /**
     * Creates the task executing the the given step in the context of the given execution.
     *
     ...
     */
    protected FutureTask<StepExecution> createTask(final Step step, StepExecution masterStepExecution,
